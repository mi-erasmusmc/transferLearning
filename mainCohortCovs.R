...
phenoTypeDefinition <- PhenotypeLibrary::getPlCohortDefinitionSet(1152:1215)
cohortsToCreate <- rbind(cohortsToCreate, phenoTypeDefinition |> dplyr::select(-"json"))
...
covariateSettings <- list(FeatureExtraction::createCovariateSettings(
